...
4. Optionally:
   ...
   - If they want a PDF to print or pass to a coordinator, tell them to export it from MindMeister on the web. There's no export tool available in this session.
